...
2. look for one of the following strings in ***UTF-16 Little Endian*** encoding
...
3. the strings you found should be together in this order but with `00 0B` or `01 0B` in between them
